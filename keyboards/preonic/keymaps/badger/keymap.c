...
#define LONG_GUITAR_SOUND Q__NOTE(_E5), Q__NOTE(_A5), Q__NOTE(_D6), Q__NOTE(_G6), ED_NOTE(_E7), E__NOTE(_CS7), E__NOTE(_E6), E__NOTE(_A6), M__NOTE(_CS7, 20),
...
float macLayerSong[][2]                = SONG(LONG_GUITAR_SOUND);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY]   = LAYOUT_preonic_2x2u(
      ...
      KC_LCTL,  KC_LGUI,  KC_LALT,  RAISE,    P_ADJ,              KC_SPC,             LOWER,    KC_RALT,  KC_RGUI,  KC_RCTL),
  ...
  [_QWERTY_MAC]   = LAYOUT_preonic_2x2u(
      ...
      KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, \
      KC_LCTL,  KC_LALT,  KC_LGUI,  RAISE,    ADJUST,             KC_SPC,             LOWER,    KC_RGUI,  KC_RALT,  KC_RCTL),
  ...
  [_LOWER]    = LAYOUT_preonic_2x2u(
      ...
      _______,  KC_0,     KC_DOT,   KC_EQL,   _______,            _______,            _______,  _______,  _______,  _______),
