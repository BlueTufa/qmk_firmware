...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCTION]   = LAYOUT_60_ansi(\
     ...
     _______,   _______,  _______,  IJ_DEBG,  IJ_FILE,   _______,  _______,  _______,  _______,  _______,  _______,  _______,            \
  ...
  [_MACRO]     = LAYOUT_60_ansi(\
     ...
     _______,   _______,  _______,  CONST,    _______,   SHEBANG,  TS_IMPT,  _______,  _______,  _______,  _______,  _______,            \
     _______,   _______,  _______,                       _______,                                _______,  _______, _______,    _______),
