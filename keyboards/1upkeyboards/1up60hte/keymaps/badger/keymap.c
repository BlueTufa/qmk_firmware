...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOVE_LINUX] = LAYOUT_tsangan(\
     KC_GRV,     VD_1,     VD_2,     KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   ______, ______, \
  ...
  [_ADJUST]     = LAYOUT_tsangan(\
     ...
     _______,   DF_1,     _______,  KC_CAPS,  _______,   KC_MPRV,  KC_MNXT,  KC_MUTE,  KC_WBAK,  KC_WFWD,  KC_WSCH,  _______,   _______,  \
     _______,   _______,  _______,  _______,  _______,   _______,  _______),
