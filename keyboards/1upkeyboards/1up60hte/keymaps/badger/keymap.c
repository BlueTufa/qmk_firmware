...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOVE]    = LAYOUT_tsangan(\
     MAC_FRC,    MM_LEFT,  MM_RGHT,  KC_HASH,  KC_DLR,   KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_UNDS,   KC_PLUS,  KC_PIPE,  KC_TILD, \
     KC_BACK,    IJ_STEP,  IJ_INTO,  IJ_OUT,   IJ_RUN,   IJ_STOP,  IJ_TOP,   WD_BACK,  KC_HOME,  KC_END,   WD_FRWD,  IJ_BACK,   IJ_FWD,   WD_DELE, \
     _______,    MM_LH,    MM_MAX,   MM_RH,    IJ_FIND,  IJ_LINE,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_COLN,  KC_DQUO,   _______,  \
     _______,    MM_UH,    MM_BH,    MAC_CPY,  MAC_PST,  SHEBANG,  IJ_BOTT,  IJ_REN,   IJ_IMPL,  IJ_DECL,  IJ_USAG,  _______,   _______,  \
     _______,    _______,  _______,                      _______,                                _______,            _______,   _______),

  [_FUNCTION] = LAYOUT_tsangan(\
     KC_ESC,    KC_F1,    KC_F2,    KC_F3,    KC_F4,     KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   _______, _______, \
     _______,   VS_EXP,   VS_DBG,   VS_CMD,   IJ_RFMT,   IJ_TERM,  KC_MPLY,  KC_PGUP,  _______,  _______,  KC_PGDN,  KC_VOLD,   KC_VOLU,  KC_DEL, \
  ...
  [_MACRO]     = LAYOUT_tsangan(\
    ...
    _______,   SELECT,   KC_UP,    _______,  SED,       KC_MSTP,  KC_MPLY,  KC_PGUP,  BASH_IF,  _______,  KC_PGDN,  P_BRACK,   _______,  _______, \
    _______,   KC_LEFT,  KC_DOWN,  KC_RGHT,  FOR_LOOP,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  \
